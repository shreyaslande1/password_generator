...
function App() {
  ...
  const copypassword = useCallback(()=>{
    ...
    passwodRef.current?.setSelectionRange(0,4)
      ...
      <div className='flex text-5m gap-x-2'>
        ...
        <div className='flex item-center gap-x-1'>
          <input type="checkbox"
            ...
            <label htmlFor='charecterinput' className='text-white'>numbers</label>
        </div>
        <div className='flex item-center gap-x-1'>
          <input type="checkbox"
            ...
            <label htmlFor='charecterinput' className='text-white'>charecters</label>
        </div>
      </div>
    </div>
  </div>
